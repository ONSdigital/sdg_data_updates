...
table_people_nsa_START_row <- 294
table_people_nsa_END_row <- 375

# Not in Education, Employment or Training ('NEET') by age: Men (not seasonally adjusted)
table_men_nsa_START_row <- 385
table_men_nsa_END_row <- 466

# Not in Education, Employment or Training ('NEET') by age: Women (not seasonally adjusted)
table_woman_nsa_START_row <- 476
table_woman_nsa_END_row <- 557
