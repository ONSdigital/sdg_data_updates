...
source("update_8-1-1.R") # does the donkey-work of making the csv - 
...
csv_filename <- paste0(date, "_update_8-1-1.csv")
qa_filename <- paste0(date, "_8-1-1_checks.html") 
...
rmarkdown::render('8-1-1_checks.Rmd',
