...
rate_mismatches_country_of_birth <- SDGupdater::count_mismatches(calculations_country_of_birth$Rates_Neonatal_check, 
...
age_plot <- all_data %>% 
  filter(Region == "" &
           ...
           Birthweight == "" &
           Age != "Not stated" &
           Country == "England and Wales linked deaths" &
           (`Country of birth` == "" | is.na(`Country of birth`))) %>% 
  ggplot(data = .,
       aes(x = Year,
           y = Value)) +
