...
source("update_4-c-1.R") # does the donkey-work of making the csv - 
...
csv_filename <- paste0(date, "_4-c-1.csv")
qa_filename <- paste0(date, "_4-c-1_checks.html") 
...
# # If you have a QA document written in Rmarkdown this is how you can run it and save it
 rmarkdown::render('4-c-1_checks.Rmd',
