...
source("update_7-3-1.R") # does the donkey-work of making the csv - 
...
csv_filename <- paste0(date, "_update_7-3-1.csv")
qa_filename <- paste0(date, "_7-3-1_checks.html") 
...
rmarkdown::render('7-3-1_checks.Rmd',
