...
source("update_9-c-1.R") # does the donkey-work of making the csv - 
...
csv_filename <- paste0(date, "_update_9-c-1.csv")
qa_filename <- paste0(date, "_9-c-1_checks.html") 
...
rmarkdown::render('9-c-1_checks.Rmd',
