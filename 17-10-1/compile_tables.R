...
source("update_17-10-1.R") # does the donkey-work of making the csv - 
...
csv_filename <- paste0(date, "_update_17-10-1.csv")
qa_filename <- paste0(date, "_17-10-1_checks.html") 
...
rmarkdown::render('17-10-1_checks.Rmd',
