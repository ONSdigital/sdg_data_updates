...
Yearly_plot <- Yearly_data %>%
  ...
  ggtitle("Proportion of youth not in education, employment or training by Year (Annual)")
...
plot <- joined_data %>%
  ...
  theme(axis.text.y = element_text(size = 7)) +
  ggtitle("Proportion of youth not in education, employment or training Quarterly")
