...
# Initial date: 17/02/2023
# purpose: set up for 3-9-2 indicator update, and save output files
...
source("3-9-2_update.R") # does the donkey-work of making the csv
...
csv_filename <- paste0(date, "_3-9-2_.csv")
qa_filename <- paste0(date, "_3-9-2_checks.html") 

write.csv(csv_output, paste0(output_folder, "/", csv_filename), row.names = FALSE)

# # If you have a QA document written in Rmarkdown this is how you can run it and save it
rmarkdown::render('3-9-2_checks.Rmd', output_file = paste0(output_folder, "/", qa_filename))
