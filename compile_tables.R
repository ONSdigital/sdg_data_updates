...
source("update_3-4-1.R") # does the donkey-work of making the csv
...
csv_filename <- paste0(date, "_update_3-4-1.csv")
qa_filename <- paste0(date, "_update_3-4-1_checks.html") 
