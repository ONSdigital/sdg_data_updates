...
no_value_rows_filtered <- no_value_rows %>% 
  filter(`Birthweight (grams)` != "Unlinked deaths" &
           `Birthweight (grams)` != "Not stated" & 
           Age != "Not stated" &
           `Country of birth` != "Other/Not stated" &
           `Country of birth` != "Born in Antarctica or Oceania") %>% 
  mutate(unexpected = case_when(
    Sex != "" & `Birthweight (grams)` == "" & Age == "" & `Neonatal period` == "" ~ TRUE,
    `Birthweight (grams)` != "" & Sex == "" & Age == "" & `Neonatal period` == "" ~ TRUE,
    Age != "" & `Birthweight (grams)` == "" & Sex == "" & `Neonatal period` == "" ~ TRUE,
    `Neonatal period` != "" & `Birthweight (grams)` == "" & Age == "" & Sex == "" ~ TRUE,
    TRUE ~ FALSE)) %>% 
