...
packages <- c("stringr", "dplyr", "openxlsx", "tidyr", "janitor", "lubridate",
...
source("update_8-10-1.R") # does the donkey-work of making the csv - 
...
csv_filename <- paste0(date, "_update_8-10-1.csv")
qa_filename <- paste0(date, "_8-10-1_checks.html") 
...
rmarkdown::render('8-10-1_checks.Rmd',
