...
joined_data <- live_data %>% 
  ...
  rename(type_of_contraception = types_of_contraception) %>%
  bind_rows(new_data)
...
comparison <- joined_data %>% 
  ...
  select(year, age, main_method_of_contraception, type_of_contraception, region_name, la_name, value, dataset) %>% 
