...
renamed_seizures_main_data <- renamed_seizures_main_data %>% 
  select(c("Year", "Quarter", "Total Number of Seizures", "Caviar & Caviar extract", "Live Coral & Coral Derivatives", "Ivory and Items Containing Ivory", "Live Animals and Birds", "Live Plants", "Parts or Derivatives of Animals/Birds", "Parts or Derivatives of Plants", "Timber or Wood Products", "Preparations Of Oriental Medicine Which Include Parts & Derivatives Of Endangered Species", "Butterflies"))
...
seizures_main_data_totals <-  renamed_seizures_main_data %>% 
  select(c("Year", "Total Number of Seizures", "Caviar & Caviar extract", "Live Coral & Coral Derivatives", "Ivory and Items Containing Ivory", "Live Animals and Birds", "Live Plants", "Parts or Derivatives of Animals/Birds", "Parts or Derivatives of Plants", "Timber or Wood Products", "Preparations Of Oriental Medicine Which Include Parts & Derivatives Of Endangered Species", "Butterflies"))
...
seizures_main_data_totals$`Caviar & Caviar extract` <- as.numeric(seizures_main_data_totals$`Caviar & Caviar extract`)
seizures_main_data_totals$`Live Coral & Coral Derivatives` <- as.numeric(seizures_main_data_totals$`Live Coral & Coral Derivatives`)
...
seizures_main_data_totals$`Parts or Derivatives of Animals/Birds` <- as.numeric(seizures_main_data_totals$`Parts or Derivatives of Animals/Birds`)
...
seizures_main_data_totals$`Preparations Of Oriental Medicine Which Include Parts & Derivatives Of Endangered Species` <- as.numeric(seizures_main_data_totals$`Preparations Of Oriental Medicine Which Include Parts & Derivatives Of Endangered Species`)
