...
source("update_4-2-2.R") # does the donkey-work of making the csv - 
...
csv_filename <- paste0(date, "_4-2-2.csv")
qa_filename <- paste0(date, "_4-2-2_checks.html") 
...
rmarkdown::render('4-2-2_checks.Rmd',
