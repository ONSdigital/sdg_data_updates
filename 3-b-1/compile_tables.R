...
# Initial date: 15/08/2023
# purpose: set up for 3-b-1 indicator update, and save output files
...
source("3-b-1_update.R") # does the donkey-work of making the csv
...
csv_filename <- paste0(date, "_3-b-1.csv")
qa_filename <- paste0(date, "_3-b-1_checks.html") 

write.csv(csv_output, paste0(output_folder, "/", csv_filename), row.names = FALSE)

# # If you have a QA document written in Rmarkdown this is how you can run it and save it
rmarkdown::render('3-b-1_checks.Rmd', output_file = paste0(output_folder, "/", qa_filename))
