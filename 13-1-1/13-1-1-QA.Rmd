...
# Plots
There are too many possible time series to plot here (99) but below are a few examples you can amend if there seems to be a discrepancy shown in the table above. If for all plots below you see only one shape of point marker, the original and updated datasets can be assumed identical in value for the selection shown in the plot.
```{r echo=FALSE}
