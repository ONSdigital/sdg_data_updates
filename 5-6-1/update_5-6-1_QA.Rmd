...
joined_data <-  joined_data %>%
    select(all_of(c("year", "region_name", "la_name", "age", "main_method_of_contraception", "type_of_contraception", "observation_status", "unit_multiplier", "unit_measure", "value", "dataset")))
...
comparison <- joined_data %>% 
  ...
  select(year, age, main_method_of_contraception, type_of_contraception, value, dataset) %>% 
