...
### 1-a-1
```{r}
live_data <- read.csv('https://raw.githubusercontent.com/ONSdigital/sdg-data/master/data/indicator_1-a-1.csv') %>% 
  janitor::clean_names()
...
plot_1a1 <- joined_data %>% 
  ...
  facet_wrap(vars(poverty_reduction_aid_type), nrow = 3) +
  theme_bw() +
